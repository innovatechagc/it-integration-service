...
func (s *TelegramSetupService) SendMessage(ctx context.Context, botToken, chatID, text string) error {
	...
	s.logger.Info("Telegram message sent successfully", map[string]interface{}{
		"chat_id": chatID,
		"text":    text,
	})
